...
if (tierKey === 'miss') {
  ...
  // Frozen R4 critical language: local brownout, contact slam, sub hit and hot CRT ring.
...
const output = path.join(__dirname, `f009_v6b_r5_tier_${slugs[tierKey]}_temp_audio_20260722.wav`);
